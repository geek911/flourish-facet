...
from ...forms import FacetCaregiverGadPostReferralForm
from ...models import FacetCaregiverGadPostReferral
from ..modeladmin_mixins import CrfModelAdminMixin


@admin.register(FacetCaregiverGadPostReferral, site=flourish_facet_admin)
class FacetCaregiverGadPostReferralAdmin(CrfModelAdminMixin, admin.ModelAdmin):

    form = FacetCaregiverGadPostReferralForm
