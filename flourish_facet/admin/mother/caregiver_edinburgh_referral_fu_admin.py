...
from ...forms import FacetCaregiverEdinburghReferralFUForm
from ...models import FacetCaregiverEdinburghReferralFU
from ..modeladmin_mixins import CrfModelAdminMixin


@admin.register(FacetCaregiverEdinburghReferralFU, site=flourish_facet_admin)
class FacetCaregiverEdinburghReferralFUAdmin(CrfModelAdminMixin, admin.ModelAdmin):

    form = FacetCaregiverEdinburghReferralFUForm
