...
from ...forms import FacetRelationshipFatherInvolvementForm
from ...models import FacetRelationshipFatherInvolvement
from ..modeladmin_mixins import CrfModelAdminMixin


@admin.register(FacetRelationshipFatherInvolvement, site=flourish_facet_admin)
class FacetRelationshipFatherInvolvementAdmin(CrfModelAdminMixin, admin.ModelAdmin):

    form = FacetRelationshipFatherInvolvementForm
