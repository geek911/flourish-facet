...
from ...forms import FacetCaregiverEdinburghPostReferralForm
from ...models import FacetCaregiverEdinburghPostReferral
from ..modeladmin_mixins import CrfModelAdminMixin


@admin.register(FacetCaregiverEdinburghPostReferral, site=flourish_facet_admin)
class FacetCaregiverEdinburghPostReferralAdmin(CrfModelAdminMixin, admin.ModelAdmin):

    form = FacetCaregiverEdinburghPostReferralForm
