...
from ...forms import FacetCaregiverPhqReferralFUForm
from ...models import FacetCaregiverPhqReferralFU
from ..modeladmin_mixins import CrfModelAdminMixin


@admin.register(FacetCaregiverPhqReferralFU, site=flourish_facet_admin)
class FacetCaregiverPhqReferralFUAdmin(CrfModelAdminMixin, admin.ModelAdmin):

    form = FacetCaregiverPhqReferralFUForm
