...
from ...models import MotherLocator
from ...models import FacetConsent


class MotherLocatorForm(SiteModelFormMixin, FormValidatorMixin, forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        try:
            subject_consented = FacetConsent.objects.filter(
    ...
    def clean(self):
        ...
        if subject_identifier:
            try:
                prev_instance = MotherLocator.objects.get(
                    subject_identifier=subject_identifier)
            except MotherLocator.DoesNotExist:
                pass
            else:
