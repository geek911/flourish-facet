...
from ...choices import (CALL_REASON, CONTACT_TYPE, REASONS_FOR_RESCHEDULING)


class FacetContactManager(models.Manager):

    # get instance using natural key instead of the PK
    def get_natural_key(self, subject_identifier):
        return self.get(subject_identifier=subject_identifier)


class FacetContact(NonUniqueSubjectIdentifierFieldMixin, BaseUuidModel):
